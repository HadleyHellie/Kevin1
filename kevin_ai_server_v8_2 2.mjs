...
CURRENT QUESTION ALREADY SHOWN TO LEARNER: ${lastNext || "[none]"}
...
13. NEVER use the CURRENT QUESTION ALREADY SHOWN TO LEARNER as NEXT again. Choose a different question, even if the old question would still fit the lesson.
14. Return EXACTLY these labels, one per line:
